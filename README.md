...
[![Release](https://www.shieldcn.dev/github/release/slobbe/appimage-manager.svg?size=sm&variant=secondary)](https://github.com/slobbe/appimage-manager/releases/latest)
